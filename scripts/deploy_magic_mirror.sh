...
START_MARKER='/* >>> MMM-HailoMagicMirror managed block (auto-generated by deploy_magic_mirror.sh) >>> */'
END_MARKER='/* <<< MMM-HailoMagicMirror managed block <<< */'
MARKER_NEEDLE_START='>>> MMM-HailoMagicMirror managed block'
